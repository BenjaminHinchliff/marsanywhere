...
Our work is specifically based upon Stable Diffusion 2.1 \cite{Rombach_2022_CVPR}, a high quality open source U-Net based latent diffusion model.
...
convolution layers, as shown in figure~\ref{fig:controlnet-arch} \cite{ControlNet_Zhang2023}.
