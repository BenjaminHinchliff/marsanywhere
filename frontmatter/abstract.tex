...
for Perseverance mission planning. We then apply a controlnet on stable
...
results on standard image reconstruction metrics to a mean baseline SSIM=0.6011, FID=166.00, KID=0.09328. Our work lays the foundation
for future developments in the area, targeting applications to education and
rover planning. Source available at \url{https://github.com/BenjaminHinchliff}.
